...
//
func NewMCP3008Driver(spi Connector, a gobot.Connection, options ...func(Config)) *MCP3008Driver {
	d := &MCP3008Driver{
...
func (d *MCP3008Driver) Connection() gobot.Connection { return d.connection }
...
func (d *MCP3008Driver) Start() (err error) {
	...
	d.spiConnection, err = d.connector.GetSpiConnection(bus, chip, mode, bits, maxSpeed)
	if err != nil {
		return err
	}
	return nil
