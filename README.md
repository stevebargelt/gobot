...
[![GoDoc](https://godoc.org/github.com/stevebargelt/gobot?status.svg)](https://godoc.org/github.com/stevebargelt/gobot)
...
Get the Gobot package by running this command: `go get -d -u github.com/stevebargelt/gobot`
...
import (
	...
	"github.com/stevebargelt/gobot"
	"github.com/stevebargelt/gobot/platforms/sphero"
)
...
To activate the API, import the `github.com/stevebargelt/gobot/api` package and instantiate the `API` like this:
